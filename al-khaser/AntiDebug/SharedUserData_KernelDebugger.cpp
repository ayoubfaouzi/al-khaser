...
Detailed information about KUSER_SHARED_DATA can be found here:
...
BOOL SharedUserData_KernelDebugger()
{
    ...
    // either true or false. However, this field is actually a set of bit flags, and is only zero if no debugger is
    // present.
