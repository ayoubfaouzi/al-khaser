...
BOOL WUDF_IsAnyDebuggerPresent()
{
    ...
    {
        auto WudfIsAnyDebuggerPresent =
            static_cast<pWudfIsAnyDebuggerPresent>(API::GetAPI(API_IDENTIFIER::API_WudfIsAnyDebuggerPresent));
...
BOOL WUDF_IsKernelDebuggerPresent()
{
    ...
    {
        auto WudfIsKernelDebuggerPresent =
            static_cast<pWudfIsKernelDebuggerPresent>(API::GetAPI(API_IDENTIFIER::API_WudfIsKernelDebuggerPresent));
...
BOOL WUDF_IsUserDebuggerPresent()
{
    ...
    {
        auto WudfIsUserDebuggerPresent =
            static_cast<pWudfIsKernelDebuggerPresent>(API::GetAPI(API_IDENTIFIER::API_WudfIsUserDebuggerPresent));
